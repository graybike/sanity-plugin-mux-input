...
var UpChunk__default = /*#__PURE__*/_interopDefaultCompat(UpChunk);
...
function createUpChunkObservable(uuid, uploadUrl, source) {
  return new rxjs.Observable(subscriber => {
    const upchunk = UpChunk__default.default.createUpload({
      endpoint: uploadUrl,
      file: source,
...
const Player = React.lazy(() => Promise.resolve().then(function () {
  return require('./Player-34abfb6c.cjs');
}));
...
//# sourceMappingURL=index-5bb19469.cjs.map
